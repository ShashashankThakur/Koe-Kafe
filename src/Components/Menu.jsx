...
const Menu = () => {
  return (
    <div>
      <div className='w-full bg-coffee pt-8 mb-0 md:h-[350px] h-[395px]'>
        <h1 className="text-3xl md:text-6xl font-mono text-center md:mt-4 mt-4 mb-4 text-white">M E N U</h1>
